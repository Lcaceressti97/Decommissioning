...
export class SimCardService {
  ...
  postProvider(data:any): Observable<any> {
    return this.http
      .post(`${this.localUrl}simcardsuppliers/add`, data,{
        observe: "response",
        headers: this.headers,
      })
      .pipe(
  ...
  putProvider(id:any,data:any): Observable<any> {
    return this.http
      .put(`${this.localUrl}simcardsuppliers/update/${id}`, data,{
        observe: "response",
        headers: this.headers,
      })
      .pipe(
