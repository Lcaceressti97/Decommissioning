...
import { ProcessInvoicesModalComponent } from './components/process-invoices-modal/process-invoices-modal.component';
import { SingleCustomerComponent } from './components/single-customer/single-customer.component';
import { CorporateCustomerModalComponent } from './components/corporate-customer-modal/corporate-customer-modal.component';

@NgModule({
  declarations: [
    AppComponent,
    InvoiceValidationComponent,
    ProcessInvoicesModalComponent,
