      ...
      content: [
        ...
        },
        {
          table: {
            ...
            body: [
              [
                { text: 'Nombre', fillColor: '#f0f0f0', bold: true, alignment: 'center' },
                { text: 'Valor', fillColor: '#f0f0f0', bold: true, alignment: 'center' },
                { text: 'Descripción', fillColor: '#f0f0f0', bold: true, alignment: 'center' },
              ...
              ...data.map((item) => [
                ...
                { text: item.value, alignment: 'center' },
