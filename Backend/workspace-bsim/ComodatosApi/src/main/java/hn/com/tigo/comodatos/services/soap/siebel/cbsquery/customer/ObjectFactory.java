 ...
 * generated in the hn.com.tigo.comodatos.services.soap.siebel.cbsquery.customer package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExecuteTaskResponse_QNAME = new QName("http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", "executeTaskResponse");
    private final static QName _ExecuteTask_QNAME = new QName("http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", "executeTask");
    private final static QName _AdapterException_QNAME = new QName("http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", "AdapterException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hn.com.tigo.comodatos.services.soap.siebel.cbsquery.customer
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", name = "executeTaskResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", name = "executeTask")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.siebel.adapter.orchestrator.josm.tigo.com.hn/", name = "AdapterException")
