 ...
 * 
 */
@WebServiceClient(name = "EmailService", targetNamespace = "http://tigo.hn/resources/emailService", wsdlLocation = "file:/C:/Users/htc/Downloads/NotifyInvoiceListener/NotifyInvoiceListener/src/main/resources/EmailService.wsdl")
public class EmailService_Service extends Service {
	...
	static {
		...
		try {
			url = new URL(
					"file:/C:/Users/htc/Downloads/NotifyInvoiceListener/NotifyInvoiceListener/src/main/resources/EmailService.wsdl");
	...
	/**
	 * 
	 * @return returns EmailService
	 */
	@WebEndpoint(name = "EmailService_Port")
	public EmailService getEmailServicePort() {
		return super.getPort(new QName("http://tigo.hn/resources/emailService", "EmailService_Port"),
				EmailService.class);
	}
