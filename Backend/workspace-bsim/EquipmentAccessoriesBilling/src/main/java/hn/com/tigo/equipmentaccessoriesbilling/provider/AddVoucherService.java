...
public class AddVoucherService extends AbstractDriver<VoucherType>{
	...
	public String getRequest(VoucherType voucherType, Map<String, String> parameters) {
		...
		String buildRequest;
		try {
			buildRequest = this.getRequest(voucherType, VoucherType.class, "addVoucher",
					parameters.get("USER_VOUCHER_SERVICE"),parameters.get("PASS_VOUCHER_SERVICE"));
			...
			throw new RuntimeException("Error construyendo SOAP addVoucher", e);
		}
