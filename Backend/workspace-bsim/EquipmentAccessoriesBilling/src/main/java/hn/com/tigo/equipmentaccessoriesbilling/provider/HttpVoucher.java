...
public class HttpVoucher extends PostMethod<String>{
	 ...
	 */
	@Override
	public String getResponse(final String response, final int responseCode, final String responseMessage, final InvoiceUtils utils)
