...
public class BillingController {
    ...
    @GetMapping("/invoicesByNameOrRtn")
    public ResponseEntity<Object> getAllPendingByNameOrRtn(
    		@RequestParam(required = false) String name,
    	    @RequestParam(required = false) String rtn,
    		HttpServletRequest request) {
        return exceptionHandler.handleExceptions(() -> this.billingService.getAllPendingByNameOrRtn(name, rtn), request);
    }
