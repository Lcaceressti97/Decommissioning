...
@Table(name = "MEA_CANCEL_INVOICE_WITH_FN")
@Entity
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CancelInvoiceWithFiscalNoEntity implements Serializable {
	...
	public CancelInvoiceWithFiscalNoModel entityToModel() {
		CancelInvoiceWithFiscalNoModel model = new CancelInvoiceWithFiscalNoModel();
