...
public interface IBillingRepository extends JpaRepository<BillingEntity, Long> {
        ...
        @Query(value = "SELECT ID, INVOICE_TYPE, STATUS, EXONERATION_STATUS, CUSTOMER, SELLER, PRIMARY_IDENTITY, CREATED "
                        + "FROM MEA_BILLING WHERE STATUS = 2 AND LOWER(CUSTOMER) LIKE :name  ORDER BY CREATED DESC", nativeQuery = true)
        List<Object[]> getAllEmitedByName(@Param("name") String name);

        @Query(value = "SELECT ID, INVOICE_TYPE, STATUS, EXONERATION_STATUS, CUSTOMER, SELLER, PRIMARY_IDENTITY, CREATED "
                        + "FROM MEA_BILLING WHERE STATUS = 2 AND LOWER(CUSTOMER_ID) LIKE :rtn ORDER BY CREATED DESC", nativeQuery = true)
        List<Object[]> getAllEmitedByRtn(@Param("rtn") String rtn);
        ...
        @Query(value = "SELECT * FROM MEA_BILLING WHERE " +
                        ...
                        "OR (:type = 4 AND PRIMARY_IDENTITY = :value AND CHANNEL NOT IN (2, 4)))", nativeQuery = true)
        ...
        Page<BillingEntity> getCreditInvoicesBySellerBranchOffice(Pageable pageable, Long status, String seller,
                        List<Long> idBranchOffices);
        ...
        @Query(value = "SELECT * " +
                        ...
                        +
                        "ORDER BY CREATED DESC", countQuery = "SELECT COUNT(*) " +
                                        "FROM MEA_BILLING " +
                                        "WHERE (:status IS NULL OR STATUS = :status) " +
                                        "  AND CHANNEL NOT IN (2, 4) " +
                                        "  AND INVOICE_TYPE IN ('FS2','FS4','FC2','FC4') " +
                                        "  AND (:customer IS NULL OR TRIM(:customer) = '' OR UPPER(CUSTOMER) LIKE '%' || UPPER(:customer) || '%') "
                                        +
                                        "  AND (:customerId IS NULL OR TRIM(:customerId) = '' OR UPPER(CUSTOMER_ID) LIKE '%' || UPPER(:customerId) || '%')", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM MEA_BILLING " +
                        ...
                        "  AND INVOICE_TYPE IN ('FS2','FS4','FC2','FC4') " +
                        "ORDER BY CREATED DESC", nativeQuery = true)
        Page<BillingEntity> getEmitedInvoices(Pageable pageable);
        ...
        @Query(value = "SELECT * FROM MEA_BILLING " +
                        ...
                        "  AND INVOICE_TYPE IN ('FS2','FS4','FC2','FC4') " +
                        "ORDER BY CREATED DESC", nativeQuery = true)
        Page<BillingEntity> getEmitedInvoicesBySellerBranchOffice(Pageable pageable,
                        @Param("seller") String seller,
                        @Param("idBranchOffices") List<Long> idBranchOffices);
        ...
        @Query(value = "SELECT * FROM MEA_BILLING " +
                        ...
                        "  AND INVOICE_TYPE IN ('FS2','FS4','FC2','FC4') " +
                        "ORDER BY CREATED DESC", nativeQuery = true)
        Page<BillingEntity> getEmitedInvoicesByBranchOffice(Pageable pageable,
                        @Param("idBranchOffices") List<Long> idBranchOffices);
        ...
        @Query(value = "SELECT * " +
                        ...
                        "ORDER BY CREATED DESC", countQuery = "SELECT COUNT(*) " +
                                        ...
                                        +
                                        "  AND (:customerId IS NULL OR TRIM(:customerId) = '' OR UPPER(CUSTOMER_ID) LIKE '%' || UPPER(:customerId) || '%')", nativeQuery = true)
        Page<BillingEntity> searchEmitedByCustomerOrCustomerId(Pageable pageable,
                        @Param("customer") String customer,
                        @Param("customerId") String customerId);
        ...
        @Query(value = "SELECT * " +
                        ...
                        "ORDER BY CREATED DESC", countQuery = "SELECT COUNT(*) " +
                                        ...
                                        +
                                        "  AND (:customerId IS NULL OR TRIM(:customerId) = '' OR UPPER(CUSTOMER_ID) LIKE '%' || UPPER(:customerId) || '%')", nativeQuery = true)
        Page<BillingEntity> searchEmitedByCustomerOrCustomerIdBySellerBranchOffice(
                        Pageable pageable,
                        @Param("seller") String seller,
                        @Param("idBranchOffices") List<Long> idBranchOffices,
                        @Param("customer") String customer,
        ...
        @Query(value = "SELECT * " +
                        ...
                        "ORDER BY CREATED DESC", countQuery = "SELECT COUNT(*) " +
                                        ...
                                        +
                                        "  AND (:customerId IS NULL OR TRIM(:customerId) = '' OR UPPER(CUSTOMER_ID) LIKE '%' || UPPER(:customerId) || '%')", nativeQuery = true)
        Page<BillingEntity> searchEmitedByCustomerOrCustomerIdByBranchOffice(
                        Pageable pageable,
                        @Param("idBranchOffices") List<Long> idBranchOffices,
                        @Param("customer") String customer,
                        @Param("customerId") String customerId);
