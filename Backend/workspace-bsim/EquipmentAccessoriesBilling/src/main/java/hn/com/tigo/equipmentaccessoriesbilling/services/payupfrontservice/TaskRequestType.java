...
@XmlType(name = "TaskRequestType", namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1", propOrder = {
    "transactionId",
    "parameters"
})
public class TaskRequestType {

    @XmlElement(namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1", required = true)
