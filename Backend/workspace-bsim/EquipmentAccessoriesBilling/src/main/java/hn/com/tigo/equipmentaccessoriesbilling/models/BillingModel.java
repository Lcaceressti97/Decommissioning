...
public class BillingModel {
	...
	@Pattern(regexp = "^(FS[1-4]|FC[1-4]|SHP|SHO)$", message = "The INVOICE TYPE is not valid and must be one of the following types: FS1, FS2, FS3, FS4, FC1, FC2, FC3, FC4, SHP, SHO")
	...
	@Size(max = 30, message = "ACCTCODE must not exceed {max} characters")
	...
	private String authEmissionDescription;

	@Valid
	@NotNull(message = "invoiceDetails cannot be null")
