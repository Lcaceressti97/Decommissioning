...
public class ProcessQueue {
    ...
    public void getProps() {
        ...
        try {
            ...
            if (prop == null || prop.getQueueProperties() == null || prop.getQueueProperties().isEmpty()) {
                throw new IllegalStateException("Queue properties empty or not loaded");
            }
        } catch (IOException e) {
            LOGGER.error("No se logró leer archivo de propiedades: " + e.getMessage(), e);
            throw new IllegalStateException("Unable to load queue properties", e);
        }
    }
    ...
    private String methodPost(String request) {
        ...
        try {
            ...
            LOGGER.error("ERROR: en api NotifyEvent: " + e.getMessage(), e);
            // Propaga mensaje para que wrap() lo clasifique bien
            throw new RuntimeException("NotifyEvent failure: " + e.getMessage(), e);
        }
