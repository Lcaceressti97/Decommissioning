...
public class ReleaseSerialBsimService {
	...
	public ReleaseSerialBsimService(IConfigParametersService configParametersService, ILogsServicesService logsServicesService) {
		super();
		this.configParametersService = configParametersService;
        this.logsServicesService = logsServicesService;
    }

	public ReserveSerialBsimModel releaseSeries(String accessToken, String inventoryType, String itemCode,
		...
		if (channelEntity.getLogs() == 1) {
			...
			logModel.setService("RELEASE SERIAL SERVICE");
