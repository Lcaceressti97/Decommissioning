...
public class CustomerInfoProvider {
	...
	public CustomerInfoModel getCustomerInfoByServiceAccount(final String serviceAccount, String url) throws MalformedURLException {
		CustomerInfoModel customerInfo = new CustomerInfoModel();
		CBSQueryCustomerInfoTaskService cBSQueryCustomerInfoTaskService;
		
		try {
			
		cBSQueryCustomerInfoTaskService = new CBSQueryCustomerInfoTaskService(new URL(url));
	...
	public CustomerInfoModel getCustomerInfoByAcctCode(final String acctCode, String url) throws MalformedURLException {
