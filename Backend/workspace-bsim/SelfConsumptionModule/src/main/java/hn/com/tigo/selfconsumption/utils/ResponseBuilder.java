...
import hn.com.tigo.selfconsumption.models.GeneralError;
import hn.com.tigo.selfconsumption.models.GeneralResponse;
...
public class ResponseBuilder {
	...
	public ResponseEntity<Object> buildErrorResponse(Exception ex, HttpServletRequest request) {
		...
		HttpStatus statusCode = (HttpStatus) responseEntityBody.getStatusCode();
