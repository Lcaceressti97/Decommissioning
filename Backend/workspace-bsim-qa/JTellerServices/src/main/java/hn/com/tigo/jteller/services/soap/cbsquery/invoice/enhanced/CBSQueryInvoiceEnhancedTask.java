...
public interface CBSQueryInvoiceEnhancedTask {
     ...
     * @param arg0
     * @return
     *     returns hn.com.tigo.jteller.services.soap.cbsquery.invoice.enhanced.TaskResponseType
     * @throws AdapterException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "executeTask", targetNamespace = "http://task.cbs2.adapter.orchestrator.josm.tigo.com.hn/", className = "hn.com.tigo.jteller.services.soap.cbsquery.invoice.enhanced.ExecuteTask")
    @ResponseWrapper(localName = "executeTaskResponse", targetNamespace = "http://task.cbs2.adapter.orchestrator.josm.tigo.com.hn/", className = "hn.com.tigo.jteller.services.soap.cbsquery.invoice.enhanced.ExecuteTaskResponse")
