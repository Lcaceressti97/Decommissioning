...
public class ArsInvoiceInfo {
	@SerializedName("ars:BillCycleID")
	private Integer arsBillCycleID;
	...
	@SerializedName("ars:EXTTransType")
	private String arsExtTransType;

	public String getArsExtTransType() {
		return arsExtTransType;
	}

	public void setArsExtTransType(String arsExtTransType) {
		this.arsExtTransType = arsExtTransType;
	}

	@SerializedName("ars:DueDate")
	private Long arsDueDate;

	public Integer getArsBillCycleID() {
		return arsBillCycleID;
	}

	public void setArsBillCycleID(Integer arsBillCycleID) {
	...
	public Long getArsInvoiceID() {
		return arsInvoiceID;
	}

	public void setArsInvoiceID(Long arsInvoiceID) {
	...
	public String toString() {
		return "ArsInvoiceInfo [arsBillCycleID=" + arsBillCycleID + ", arsAdditionalProperty=" + arsAdditionalProperty
				+ ", arsOpenAmount=" + arsOpenAmount + ", arsAcctKey=" + arsAcctKey + ", arsInvoiceNo=" + arsInvoiceNo
				+ ", arsSubKey=" + arsSubKey + ", arsPrimaryIdentity=" + arsPrimaryIdentity + ", arsTransType="
				+ arsTransType + ", arsBillCycleBeginTime=" + arsBillCycleBeginTime + ", arsCustKey=" + arsCustKey
				+ ", arsTAXAmount=" + arsTAXAmount + ", arsCurrencyID=" + arsCurrencyID
				+ ", arsInvoiceID=" + arsInvoiceID + ", arsStatus=" + arsStatus + ", arsNPE=" + arsNPE
				+ ", arsBillCycleEndTime=" + arsBillCycleEndTime + ", arsInvoiceAmount=" + arsInvoiceAmount
				+ ", arsInvoiceType=" + arsInvoiceType + ", arsOpenTaxAmount=" + arsOpenTaxAmount + ", arsInvoiceDate="
				+ arsInvoiceDate + ", arsDueDate=" + arsDueDate + "]";
	}
