...
public interface EmailService {
     ...
     * @param body
     * @return
     *     returns hn.com.tigo.selfconsumption.services.emailservice.GeneralResponse
     */
    @WebMethod(action = "sendMail")
    @WebResult(name = "generalResponseMsg", targetNamespace = "")
    @RequestWrapper(localName = "sendMessage", targetNamespace = "http://tigo.hn/resources/emailService", className = "hn.com.tigo.selfconsumption.services.emailservice.SendMessage")
    @ResponseWrapper(localName = "sendMessageResponse", targetNamespace = "http://tigo.hn/resources/emailService", className = "hn.com.tigo.selfconsumption.services.emailservice.SendMessageResponse")
