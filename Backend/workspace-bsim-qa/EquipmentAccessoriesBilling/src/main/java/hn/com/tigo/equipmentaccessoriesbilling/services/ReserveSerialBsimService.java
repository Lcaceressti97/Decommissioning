...
import hn.com.tigo.equipmentaccessoriesbilling.models.ReserveSerialBsimModel;
...
public class ReserveSerialBsimService {
    ...
    public ReserveSerialBsimService(IConfigParametersService configParametersService, ILogsServicesService logsServicesService) {
        super();
    ...
    public ReserveSerialBsimModel reserveSeries(String accessToken, String inventoryType, String itemCode,
        ...
        if (channelEntity.getLogs() == 1) {
            ...
            logModel.setService("RESERVE SERIAL SERVICE");
        ...
        if (reserveSerialResponse.getResult_code().endsWith("000")) {
            ...
            throw new BadRequestException("Error when booking series: " + reserveSerialResponse.getResult_message() + " - " + reserveSerialResponse.getReservation_result_list().get(0).getReservation_result());
        }
