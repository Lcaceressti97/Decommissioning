 ...
 * generated in the hn.com.tigo.equipmentaccessoriesbilling.services.payupfrontservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExecuteTaskResponse_QNAME = new QName("http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", "executeTaskResponse");
    private final static QName _ExecuteTask_QNAME = new QName("http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", "executeTask");
    private final static QName _AdapterException_QNAME = new QName("http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", "AdapterException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hn.com.tigo.equipmentaccessoriesbilling.services.payupfrontservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", name = "executeTaskResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", name = "executeTask")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://task.cbs3.adapter.orchestrator.josm.tigo.com.hn/", name = "AdapterException")
