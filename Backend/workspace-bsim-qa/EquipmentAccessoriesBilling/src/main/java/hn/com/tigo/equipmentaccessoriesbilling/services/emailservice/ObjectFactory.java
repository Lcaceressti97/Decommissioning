package hn.com.tigo.equipmentaccessoriesbilling.services.emailservice;
 ...
 * element interface generated in the hn.tigo.resources.emailservice package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _SendMessageResponse_QNAME = new QName("http://tigo.hn/resources/emailService",
			"sendMessageResponse");
	 ...
	 * derived classes for package: hn.tigo.resources.emailservice
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link AttachmentsDTO
	 * }{@code >}}
	 * 
	 */
	...
	public JAXBElement<AttachmentsDTO> createSendMessageAttachments(AttachmentsDTO value) {
		return new JAXBElement<AttachmentsDTO>(_SendMessageAttachments_QNAME, AttachmentsDTO.class, SendMessage.class,
				value);
	}
