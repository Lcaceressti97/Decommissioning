...
@XmlType(name = "TaskResponseType", namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1", propOrder = {
    "responseCode",
    "responseDescription",
    "parameters"
})
public class TaskResponseType {
    ...
    @XmlElement(name = "_responseCode", namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1")
    protected int responseCode;
    @XmlElement(name = "_responseDescription", namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1", required = true)
    protected String responseDescription;
    @XmlElement(namespace = "http://adapter.josm.tigo.com.hn/RequestType/V1")
